		...
		<div class="bg-white/95 backdrop-blur-xl rounded-3xl overflow-hidden bottom-sheet-enter">
			...
			<div class="px-6 py-7 space-y-4">
				...
				<input
					...
					class="w-full h-14 px-5 text-[18px] font-semibold border-2 border-purple-200 rounded-2xl bg-purple-50/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
				/>
